...
class CalcOperations:
    ...
    @staticmethod
    def find_inlet_static_temp_and_velocity(turbine_input, turbine_assum) -> (float, float):
    ...
    def find_pressure(turbine_input, turbine_assum) -> float:
        ...
        p_2 = CalcOperations.turbine_input_stagnation_pressure(turbine_input, turbine_assum) / th.p2_p1_is(turbine_input.T01/T2_prim, dc.KAPPA)
