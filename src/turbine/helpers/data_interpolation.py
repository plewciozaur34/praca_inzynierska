...
class DataInterpolation:
    ...
    stagger_50 = interp1d(
        figures_dict["stagger_50"]["x"], figures_dict["stagger_50"]["y"], kind="slinear"
    )
    stagger_55 = interp1d(
        figures_dict["stagger_55"]["x"], figures_dict["stagger_55"]["y"], kind="slinear"
    )
    stagger_60 = interp1d(
        figures_dict["stagger_60"]["x"], figures_dict["stagger_60"]["y"], kind="slinear"
    )
    stagger_65 = interp1d(
        figures_dict["stagger_65"]["x"], figures_dict["stagger_65"]["y"], kind="slinear"
    )
    stagger_70 = interp1d(
        figures_dict["stagger_70"]["x"], figures_dict["stagger_70"]["y"], kind="slinear"
    )
    stagger_75 = interp1d(
        figures_dict["stagger_75"]["x"], figures_dict["stagger_75"]["y"], kind="slinear"
    )
    stagger_80 = interp1d(
        figures_dict["stagger_80"]["x"], figures_dict["stagger_80"]["y"], kind="slinear"
    )
    tmax_c = interp1d(
        figures_dict["tmax_c"]["x"], figures_dict["tmax_c"]["y"], kind="slinear"
    )

    @staticmethod
    def chord_t_intialization(
        chord_init: str, beta_in: float, beta_out: float, idx: int
    ):
        ...
        while True:
            if chord_init == "stagger_angle":
                ...
                raise ValueError(
                    "Wrong chord initialization method. Check your spelling."
                )
