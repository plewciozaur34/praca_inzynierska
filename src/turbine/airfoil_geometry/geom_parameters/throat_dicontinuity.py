...
class RemoveThroatDiscontinuity:
    def __init__(self, pressure_surf: 'pl.Polynomial', suction_surf: 'pl.Polynomial', point0: 'c.Circle', point1: 'p.Point', point2: 'p.Point', point3: 'p.Point', point4: 'p.Point', point5: "p.Point") -> None:
